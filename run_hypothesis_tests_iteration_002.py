#!/usr/bin/env python
"""Run QQQ Risk Monitor iteration 002 research-only hypothesis tests.

Usage:
    python run_hypothesis_tests_iteration_002.py --output-dir outputs --test-output-dir research_iterations/iteration_002/tests
"""
...
from qqq_autoresearch.hypothesis_tests_iteration_002 import PREFIX, run_tests


def main() -> None:
    parser = argparse.ArgumentParser(description="Run iteration 002 QQQ hypothesis diagnostics.")
    parser.add_argument("--output-dir", default="outputs", help="Directory containing dashboard feature outputs.")
    parser.add_argument(
        "--hypotheses",
        default="research_iterations/iteration_002/hypotheses.yaml",
        help="Iteration 002 hypothesis YAML file.",
    )
    parser.add_argument("--data", default=None, help="Override daily wide feature CSV path.")
    parser.add_argument(
        "--test-output-dir",
        default="research_iterations/iteration_002/tests",
        help="Where to write iteration 002 test reports.",
    )
    ...
    print("\nIteration 002 top-line summary:")

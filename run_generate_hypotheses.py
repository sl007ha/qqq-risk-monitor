...
Usage:
    python run_generate_hypotheses.py --model qwen2.5:7b
"""
...
def main() -> None:
    ...
    parser.add_argument("--model", default=os.environ.get("OLLAMA_MODEL", "qwen2.5:7b"), help="Local Ollama model name, e.g. qwen2.5:7b, qwen2.5-coder:7b, llama3.1:8b.")
    ...
    parser.add_argument("--n-hypotheses", type=int, default=24, help="Number of hypotheses to request from the local model.")
    parser.add_argument("--max-features", type=int, default=220, help="Maximum feature rows to include in the model prompt.")
    parser.add_argument("--temperature", type=float, default=0.25, help="Ollama sampling temperature.")
    parser.add_argument("--num-ctx", type=int, default=32768, help="Requested context window for Ollama model options.")
